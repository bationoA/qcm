...
def main_page_design():
    ...
    with mid_row_cols[1]:
        ...
        st.page_link(page=os.path.join("pages", "1_Form_Based.py"),
                     label="CLICK HERE TO START Form-Based Record Lookup",
        ...
        # Tutorial video
        st.video(os.path.join("assets", "videos", "tuto_form_based_rlk.webm"), "video/webm")

    with mid_row_cols[3]:
        st.image(image=os.path.join("assets", "images", "entries_list.webp"))
        st.page_link(page=os.path.join("pages", "2_Link_Datasets.py"),
                     label="CLICK HERE TO START Dataset Merging Through Record Linkage",
                     use_container_width=True)
        with st.expander(label="Description"):
        ...
        # Tutorial video
        st.video(os.path.join("assets", "videos", "tuto_dataset_rlk.webm"), "video/webm")
